...
function read_file_to_matrix_comm_plot(file_name) {
    ...
    //iy_1=d3.min(data_obj_mc, function(d) { return d.label_x; });
    //iy_2=d3.max(data_obj_mc, function(d) { return d.label_x; });
    //
    //
    //iy_1=d3.min(data_obj_mc, function(d) { return d.label_y; });
    //iy_2=d3.max(data_obj_mc, function(d) { return d.label_y; });
...
function matrix_comm_plot(x1, x2, y1, y2) {
    ...
    //.filter(function(d) {return d.probe_group == probe_group ; })
    .style("fill", '#0d1dee') //blue
    .attr("transform", function(d) {
        //document.write(x(d.label_x) + "  " + y(d.label_y) + "  "+d.label_y+ "<br>")
