...
function histogram_degree_SNPs(file_name, probe_group) {
    ...
    d3.json(file_name, function(json) {
        ...
        y.domain(data.map(function(d, i) {
            return "id:" + allNodes_hes.indexOf(d) + " chr" + d.chrom + ':' + d.bp_position + " " + d.rs + " probe_group:" + d.probe_group;
        }));
        /* 
  x.domain(
            ...
            .on("mousedown", function(g, i) {
                ...
                for (var e in links_hes) {
                    ...
                    if (("chr" + allNodes_hes[links_hes[e].source].chrom + ':' + allNodes_hes[links_hes[e].source].bp_position) ===
                        ("chr" + data[i].chrom + ':' + data[i].bp_position) || ("chr" + allNodes_hes[links_hes[e].target].chrom + ':' + allNodes_hes[links_hes[e].target].bp_position) ===
                ...
                if (plot_chosen === "p_cir") { //plot_chosen==="p_man"){	plot_chosen==="p_cir"
                    ...
                    manhattan_plot_minmap(0, chrom_lenght, d3.min(data_weight_pvalue, function(d) {
                        ...
                        return d;
                    }) + 1, 0, 0, 0, 0, data_select_from_HDS);
